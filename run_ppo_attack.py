...
from utils import *
from PPO_attack import PPOAgent, ppo_inversion

parser = argparse.ArgumentParser(description="RLB-MI with PPO")
...
if __name__ == "__main__":
    ...
    for i in targets:
        agent = PPOAgent(state_size=z_dim, action_size=z_dim, hidden_size=256)
        recon_image = ppo_inversion(agent, G, T, alpha, z_dim=z_dim, max_episodes=max_episodes, 
                                  max_step=max_step, label=i, model_name=model_name)
